      ...
      <el-row>
        <el-col :span="5">
          <el-form-item label="协作ID" prop="cooperationId" style="margin-right:0;"  >
            <el-input v-model.trim="cooperationSelectQuery.filterQuery.cooperationId" placeholder="请输入协作ID" style="width:120px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="5">
          <el-form-item label="协作名" prop="name" style="margin-right:0;">
            <el-input v-model.trim="cooperationSelectQuery.filterQuery.name" placeholder="请输入协作名" style="width:150px"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="创建者" prop="ownerName" style="margin-right:0;">
            <el-input v-model.trim="cooperationSelectQuery.filterQuery.ownerName" placeholder="请输入创建者用户名"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="4">
          <el-form-item label="等级" prop="hasParent" style="margin-right:0;">
            <el-select v-model="cooperationSelectQuery.filterQuery.hasParent" placeholder="请选择" style="width:80px">
              <el-option
        ...
        <el-col :span="4">
          <el-form-item label="邀请链接" prop="invite" style="margin-right:0;">
            <el-select v-model="cooperationSelectQuery.filterQuery.invite" placeholder="请选择" style="width:80px">
              <el-option
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions(['listManageCooperation']),
      getCooperationData() {
        this.loading = true;
        this.listManageCooperation(this.cooperationSelectQuery).then((response) => {
